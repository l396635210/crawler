...
class WpComments
{
     ...
     * @var boolean
     *
     * @ORM\Column(name="comment_mail_notify", type="boolean", nullable=false)
     */
    private $commentMailNotify = '0';
    ...
    /**
     * Set commentMailNotify
     *
     * @param boolean $commentMailNotify
     *
     * @return WpComments
     */
    public function setCommentMailNotify($commentMailNotify)
    {
    ...
    /**
     * Get commentMailNotify
     *
     * @return boolean
     */
    public function getCommentMailNotify()
    {
