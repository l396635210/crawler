...
use DatumBundle\Form\ChannelType;

/**
 * Channel controller.
 *
 * @Route("/admin/datum/channel")
 */
class ChannelController extends Controller
{
     ...
     *
     * @Route("/", name="admin_datum_channel_index")
     * @Method("GET")
     */
    public function indexAction()
    {
        ...
        $channels = $em->getRepository('DatumBundle:Channel')->findAll();

        return $this->render('DatumBundle:Channel:index.html.twig', array(
            'channels' => $channels,
            'active' => 'datum_channel',
        ));
    }
     ...
     *
     * @Route("/new", name="admin_datum_channel_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_datum_channel_show', array('id' => $channel->getId()));
        }

        return $this->render('DatumBundle:Channel:new.html.twig', array(
            'channel' => $channel,
     ...
     *
     * @Route("/{id}", name="admin_datum_channel_show")
     * @Method("GET")
     */
    public function showAction(Channel $channel)
    {
        ...
        return $this->render('DatumBundle:Channel:show.html.twig', array(
            'channel' => $channel,
     ...
     *
     * @Route("/{id}/edit", name="admin_datum_channel_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Channel $channel)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_datum_channel_edit', array('id' => $channel->getId()));
        }

        return $this->render('DatumBundle:Channel:edit.html.twig', array(
            'channel' => $channel,
     ...
     *
     * @Route("/{id}", name="admin_datum_channel_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Channel $channel)
    {
        ...
        return $this->redirectToRoute('admin_datum_channel_index');
    }
    ...
    private function createDeleteForm(Channel $channel)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_datum_channel_delete', array('id' => $channel->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
    ...
    public function setGrabRuleAction(Request $request){
        ...
        $criteria["back"] = "admin_datum_channel_index";
